...
{
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_6,GPIO_MODE_AF_OD,GPIO_PULLUP,GPIO_AF4_I2C1},			// GPIO_4 on BMSv1.0
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_7,GPIO_MODE_AF_OD,GPIO_PULLUP,GPIO_AF4_I2C1}				// GPIO_5 on BMSv1.0
};

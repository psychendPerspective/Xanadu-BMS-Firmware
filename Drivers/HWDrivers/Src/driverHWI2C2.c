...
{
	{GPIOA,RCC_AHBENR_GPIOAEN,GPIO_PIN_9,GPIO_MODE_AF_OD,GPIO_PULLUP,GPIO_AF4_I2C2},				// PWM_1 on BMSv1.0
	{GPIOA,RCC_AHBENR_GPIOAEN,GPIO_PIN_10,GPIO_MODE_AF_OD,GPIO_PULLUP,GPIO_AF4_I2C2}				// PWM_3 on BMSv1.0
};
